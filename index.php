...
<head>
    ...
    <title>Carl John Paul Masayon - Portfolio</title>
...
<body>
    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <a href="login.php" class="hire-btn">Admin Login</a>
        </div>
    </nav>
    ...
    <footer class="footer">
        <div class="footer-container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2024 Carl John Paul Masayon. All rights reserved.</p>
            </div>
        </div>
    </footer>
